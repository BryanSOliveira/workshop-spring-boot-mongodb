...
import com.bryansantos.workshopmongo.dto.AuthorDTO;
import com.bryansantos.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null,sdf.parse("21/03/2018"), "Gone trip", "I'm going to travel to São Paulo. Hugs!", new AuthorDTO(maria));
